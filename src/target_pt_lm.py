...
TEMP_DIR = "../temp/IN12_SUP_LM/"
OUT_DIR = "../out/IN12_SUP_LM/"
...
def main():
    ...
    net = networks.ResNet18SupLargeMargin(num_classes=12, pretrained=exp_args['pretrained'], margin=3)
    pre_model = models.SupModelLM(network=net, source_loader=src_loader_train, logger=logger, no_save=no_save)
