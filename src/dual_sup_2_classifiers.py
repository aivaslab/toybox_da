...
TEMP_DIR = "../temp/DUAL_SUP_2_CLASSIFIERS/"
OUT_DIR = "../out/DUAL_SUP_2_CLASSIFIERS/"
...
def get_parser():
    ...
    parser.add_argument("-w", "--workers", default=4, type=int, help="Number of workers for data loading")
    ...
    parser.add_argument("--no-save", default=False, action="store_true", help="Use this flag to disable saving")
...
def main():
    ...
    model = models.DualSupModelWith2Classifiers(network=net, source_loader=src_loader_train,
                                                target_loader=trgt_loader_train, logger=logger,
                                                combined_batch=combined_batch, no_save=no_save)
